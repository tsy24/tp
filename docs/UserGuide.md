...
3. The remark “Medicine seems to be ineffective” will be added to Khong Guan. You can click on the elderly or use the `viewDetails` command to see the remark.
