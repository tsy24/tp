...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple ages - last age accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_AMY + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple genders - last gender accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_AMY
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple emails - last email accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_AMY + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_AMY + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple roomNumbers - last roomNumber accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_AMY + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple tags - all accepted
        Elderly expectedElderlyMultipleTags = new ElderlyBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing age prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_AGE_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + VALID_GENDER_BOB
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid gender
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + INVALID_GENDER_DESC
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Address.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
                Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND
