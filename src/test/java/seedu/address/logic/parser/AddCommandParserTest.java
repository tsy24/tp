...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + NOK_PHONE_DESC_AMY + NOK_PHONE_DESC_BOB + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
                + NOK_EMAIL_DESC_BOB + NOK_ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple ages - last age accepted
        assertParseSuccess(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_AMY + AGE_DESC_BOB
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
                + NOK_EMAIL_DESC_BOB + NOK_ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple genders - last gender accepted
        assertParseSuccess(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_AMY
                + GENDER_DESC_BOB + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
                + NOK_EMAIL_DESC_BOB + NOK_ADDRESS_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedElderly));

        // multiple nok names - last nok name accepted
        assertParseSuccess(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
                + NOK_EMAIL_DESC_BOB + NOK_ADDRESS_DESC_BOB, expectedMessage);

        // missing age prefix
        assertParseFailure(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + VALID_AGE_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
                + NOK_EMAIL_DESC_BOB + NOK_ADDRESS_DESC_BOB, expectedMessage);

        // missing gender prefix
        assertParseFailure(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + VALID_GENDER_BOB
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_NOK_PHONE_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + GENDER_DESC_BOB
        ...
        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_NOK_PHONE_DESC + AGE_DESC_BOB + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB + NOK_EMAIL_DESC_BOB
                + NOK_ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Phone.MESSAGE_CONSTRAINTS);

        // invalid age
        assertParseFailure(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + INVALID_AGE_DESC + GENDER_DESC_BOB
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB + NOK_EMAIL_DESC_BOB
                + NOK_ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Age.MESSAGE_CONSTRAINTS);

        // invalid gender
        assertParseFailure(parser, NAME_DESC_BOB + NOK_PHONE_DESC_BOB + AGE_DESC_BOB + INVALID_GENDER_DESC
                + ROOM_NUMBER_DESC_BOB + NOK_NAME_DESC_BOB + NOK_RELATIONSHIP_DESC_BOB + NOK_EMAIL_DESC_BOB
                + NOK_ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
