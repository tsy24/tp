...
class ViewDetailsCommandParserTest {
    ...
    public void parse_validArgs_returnsViewDetailsCommand() {
        assertParseSuccess(parser, "1", new ViewDetailsCommand(INDEX_FIRST));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, ViewDetailsCommand.MESSAGE_USAGE));
    }
