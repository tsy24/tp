...
public class DeleteTagCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        DeleteTagCommand expectedCommand = new DeleteTagCommand(TypicalIndexes.INDEX_FIRST, SET_ONE_TAG);
        assertParseSuccess(parser, userInput, expectedCommand);
    }

    @Test
    public void parse_missingCompulsoryField_failure() {
        String expectedMessage = String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, DeleteTagCommand.MESSAGE_USAGE);
